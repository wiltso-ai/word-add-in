...
1. Open the **Insert** tab on the ribbon and choose **Add-ins**.
...
1. Browse to the add-in manifest file, and then select **Upload**.
   ...
   ![The upload add-in dialog with buttons for browse, upload, and cancel.](../images/office-upload-add-ins-word-web.png)

1. Verify that the add-in loaded successfully. You will see a **Hello world** button on the **Home** tab on the ribbon.
1. Choose the **Hello world** button to display the task pane with the text "This add-in will insert the text 'Hello world!'".
